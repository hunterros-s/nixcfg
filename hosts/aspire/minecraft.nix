...
let
  ...
  neoforgeAttr = "neoforge-${lib.replaceStrings [ "." ] [ "_" ] mcVer}-${lib.replaceStrings [ "." ] [ "_" ] nfVer}";
  ...
  manualMod =
    ...
    pkgs.fetchurl {
      inherit pname version url hash;
    };

  petrolsparts = manualMod {
    pname = "petrolsparts";
  ...
  modpack = (pkgs.fetchPackwizModpack {
    ...
    "mods/petrolsparts-1.21.1-1.2.10.jar" = petrolsparts;
    "mods/petrolpark-1.21.1-1.4.36.jar" = petrolpark;
    "mods/create_oxidized-0.1.3.jar" = createOxidized;
    "mods/create_train_parts-0.5.0-1.21.1-6.0.10-281.jar" = createTrainParts;
    "mods/GeophilicBackported-v1.3.3 1.21.1.jar" = geophilicBackport;
  };
